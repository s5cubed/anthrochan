...
const { Permissions } = require(__dirname+'/../permission/permissions.js')
	, actions = [
		...
		{name:'edit', global:true, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'delete', global:true, passwords:true, build:true},
		{name:'lock', global:false, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'sticky', global:false, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'cyclic', global:false, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
		{name:'bumplock', global:false, auth:Permissions.MANAGE_BOARD_OWNER, passwords:false, build:true},
