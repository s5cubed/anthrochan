...
describe('decode query ip', () => {
	...
	const cases = [
		...
		{ in: { query: { ip: '10.0.0.1' }, permission: ROOT }, out: {ip: '10.0.0.1'} },
		{ in: { query: { ip: '10.0.0.1' }, permission: NO_PERMISSION }, out: null },
		{ in: { query: { ip: '8s7AGX4n.qHsw9mp.uw54Nfl.IP' }, permission: ROOT }, out: {ip: '8s7AGX4n.qHsw9mp.uw54Nfl.IP'} },
		{ in: { query: { ip: '8s7AGX4n.qHsw9mp.uw54Nfl.IP' }, permission: NO_PERMISSION }, out: {ip: '8s7AGX4n.qHsw9mp.uw54Nfl.IP'} },
	];
